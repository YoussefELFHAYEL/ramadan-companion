...
export default function Home() {
    ...
    useEffect(() => {
        ...
        if (headerQuery.length < 3) { setHeaderSuggestions([]); setHeaderOpen(false); return; }
        ...
        return () => { if (headerDebounceRef.current) clearTimeout(headerDebounceRef.current); };
    }, [headerQuery]);
    ...
    return (
        <div className="bg-gradient-mesh">
            {/* ============================================ */}
            {/* SECTION 1: Full-Screen Hero Search           */}
            {/* ============================================ */}
            <SmartSearch onSubmit={handleCitySubmit} />
